...
// ── 4b. STATE → MANDI ROAD DISTANCES (km) ────────────────────────────────────
// Index order matches MANDI_DB: Hyderabad,Warangal,Nizamabad,Khammam,Vijayawada,
// Kurnool,Guntur,Bengaluru,Mysuru,Pune,Nashik,Nagpur,Delhi,Agra,Chennai,Ahmedabad,Amritsar,Kolkata
export const STATE_MANDI_DISTANCES = {
  'Telangana':        [0,   145, 170, 195, 280, 215, 310, 570, 620, 560, 620, 500,1500,1350, 630,1100,1750,1600],
  'Andhra Pradesh':   [280, 350, 450, 300,   0, 200,  60, 560, 610, 850, 910, 780,1700,1550, 400,1300,1950,1400],
  'Maharashtra':      [600, 700, 750, 680, 900, 700, 920, 850, 900,   0, 170, 230,1400,1250,1300, 560,1800,1900],
  'Karnataka':        [570, 700, 720, 680, 550, 450, 560,   0, 145, 840, 900, 780,2100,1950, 360,1500,2400,2400],
  'Tamil Nadu':       [640, 750, 800, 700, 400, 500, 430, 360, 300,1300,1400,1300,2200,2050,   0,1900,2800,1900],
  'Gujarat':          [1100,1200,1100,1200,1350,1050,1400,1500,1600, 590, 500, 800, 900, 800,2000,   0,1600,2500],
  'Punjab':           [1750,1850,1700,1850,2000,1750,2100,2400,2500,1800,1700,1450, 460, 600,2800,1600,   0,2300],
  'West Bengal':      [1600,1700,1700,1700,1450,1700,1500,2400,2500,1900,2000,1100,1500,1600,1950,2500,2300,   0],
  'Uttar Pradesh':    [1500,1600,1500,1650,1700,1500,1800,2100,2200,1400,1400,1000, 200, 200,2200,1200, 500,1200],
  'Madhya Pradesh':   [900,1000, 900,1050,1100, 850,1150,1500,1600, 820, 750, 320, 800, 750,1800, 700,1300,1500],
  'Rajasthan':        [1300,1400,1250,1450,1550,1200,1600,1800,1900,1000, 950, 900, 700, 600,2300, 500, 900,2100],
  'Bihar':            [1700,1800,1700,1800,1750,1800,1800,2400,2500,2000,2100,1200,1000,1100,2400,2100,1200, 600],
  'Odisha':           [1200,1200,1350,1200, 950,1300,1000,1600,1700,1700,1800,1100,1600,1700,1500,2200,2500, 500],
  'Kerala':           [1000,1100,1150,1050, 830, 900, 850, 600, 500,1600,1700,1700,2600,2500, 700,2200,3100,2400],
  'Haryana':          [1600,1700,1600,1750,1800,1600,1900,2200,2300,1500,1400,1200, 200, 300,2400,1300, 350,1900],
  'Assam':            [2500,2600,2600,2600,2400,2600,2500,3100,3200,2900,3000,2100,1700,1800,3000,3200,2600,1100],
  'Jharkhand':        [1400,1500,1500,1450,1300,1500,1350,2200,2300,1800,1900, 900,1200,1300,2200,2200,1700, 500],
  'Chhattisgarh':     [850, 900, 950, 900, 900, 950, 950,1400,1500,1300,1350, 500,1300,1200,1700,1700,2000,1100],
  'Himachal Pradesh': [1900,2000,1900,2050,2200,1950,2300,2500,2600,1900,1800,1600, 550, 700,3000,1700, 300,2600],
  'Uttarakhand':      [1700,1800,1700,1850,1950,1750,2050,2300,2400,1700,1600,1400, 350, 500,2800,1500, 500,2400],
};
